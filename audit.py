...
CATEGORY = {
    ...
    "grant_expired": "grant", "grant_ip_changed": "grant",
    "wg_config_generated": "grant",
    ...
    "webhook_forwarded": "webhook", "webhook_failed": "webhook",
    "webhook_suppressed": "webhook",
    "webhook_enabled": "webhook", "webhook_disabled": "webhook",
}
